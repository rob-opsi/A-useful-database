<?php
	...
	$getCategory = mysqli_query($con, "SELECT * FROM movie_genre WHERE id='$genreNumber'");
...
<button class="btn btn-default" style="float:right;" onclick="location.href='items.php?category=<?php echo $item_category; ?>'"><i class="fa fa-backward"></i>  Other <?php echo $category . 's'; ?></button>
</div>
